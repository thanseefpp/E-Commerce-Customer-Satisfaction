...
from src.CustomerSatisfaction.pipeline.deployment_pipeline import prediction_service_loader
...
def main():
    ...
    if st.button("Predict"):
        ...
        st.success(f"Your Customer Satisfactory rate(range between 0 - 5) with given product details is :-{pred}")
